...
CREATE INDEX [IX_Message_Id] ON [dbo].[Resources]([Message_Id])
CREATE INDEX [IX_Report_Id] ON [dbo].[Resources]([Report_Id])
...
CREATE INDEX [IX_ReportDetails_Id] ON [dbo].[CustomPropertyValues]([ReportDetails_Id])
...
ALTER TABLE [dbo].[Resources] ADD CONSTRAINT [FK_dbo.Resources_dbo.Messages_Message_Id] FOREIGN KEY ([Message_Id]) REFERENCES [dbo].[Messages] ([Id])
ALTER TABLE [dbo].[Resources] ADD CONSTRAINT [FK_dbo.Resources_dbo.Reports_Report_Id] FOREIGN KEY ([Report_Id]) REFERENCES [dbo].[Reports] ([Id]) ON DELETE CASCADE
...
ALTER TABLE [dbo].[CustomPropertyValues] ADD CONSTRAINT [FK_dbo.CustomPropertyValues_dbo.ReportDetails_ReportDetails_Id] FOREIGN KEY ([ReportDetails_Id]) REFERENCES [dbo].[ReportDetails] ([Id]) ON DELETE CASCADE
